          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <c:url var="addUrl" value="/product/addSanPham" />
	              <form:form modelAttribute="addSanPham" method="POST" action="${addUrl}">
				                 ...
				                 <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
						                <div class="tm-product-img-edit mx-auto">
						                  <form:label class ="txtImage" path="hinhanh" for="description"
						                  >Hình ảnh</form:label>
                	...
                	<div class="col-12">
		                <button type="submit" value="Save" class="btn btn-primary btn-block text-uppercase">Thêm Sản Phẩm</button>
		             </div>
