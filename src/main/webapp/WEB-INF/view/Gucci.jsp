						...
						<div class="row">
								...
								<div class="side border mb-1">
									...
									<div class="block-26 mb-2">
										...
										<ul>
											...
											<c:url var="product75" value="/khachhang/product7_5ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product75}">7.5</a></li>
		                                    					<c:url var="product10" value="/khachhang/product10ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product10}">10</a></li>
											<c:url var="product15" value="/khachhang/product15ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product15}">15</a></li>
											<c:url var="product20" value="/khachhang/product20ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product20}">20</a></li>
											<c:url var="product30" value="/khachhang/product30ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product30}">30</a></li>
											<c:url var="product50" value="/khachhang/product50ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product50}">50</a></li>
											<c:url var="product100" value="/khachhang/product100ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product100}">100</a></li>
											<c:url var="product120" value="/khachhang/product120ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product120}">120</a></li>
											<c:url var="product150" value="/khachhang/product150ml?maThuongHieu=${THUONGHIEU2}"/>
											<li><a href="${product150}">150</a></li>
											<c:url var="product200" value="/khachhang/product200ml?maThuongHieu=${THUONGHIEU2}"/>
							...
							<div class="col-sm-12">
								<div class="side border mb-1">
									<h3>Money</h3>
									<ul>
										<c:url var="duoi500" value="/khachhang/productduoi500?maThuongHieu=${THUONGHIEU2}"/>
                                		
										<li><a href="${duoi500}">Dưới 500.000</a></li>
										<c:url var="tu500Den1000" value="/khachhang/product500-1000?maThuongHieu=${THUONGHIEU2}"/>
										<li><a href="${tu500Den1000}">500.000 - 1.000.000</a></li>
										
										<c:url var="tu1000Den2000" value="/khachhang/product1000-2000?maThuongHieu=${THUONGHIEU2}"/>
										<li><a href="${tu1000Den2000}">1.000.000 - 2.000.000</a></li>
										
										<c:url var="tu2000Den5000" value="/khachhang/product2000-5000?maThuongHieu=${THUONGHIEU2}"/>
										<li><a href="${tu2000Den5000}">2.000.000 - 5.000.000</a></li>
										
										<c:url var="tren5000" value="/khachhang/productTren5000?maThuongHieu=${THUONGHIEU2}"/>
							...
							<div class="col-sm-12">
								<div class="side border mb-1">
									<h3>Giới tính</h3>
									<ul>
										<c:url var="man" value="/khachhang/productMen?maThuongHieu=${THUONGHIEU2}"/>
										<li><a href="${man}">Man</a></li>
										<c:url var="woman" value="/khachhang/productWoman?maThuongHieu=${THUONGHIEU2}"/>
