...
function setForm() {
	var tt =document.getElementById("spnoibat");
	var tt =document.getElementById("spbanchay");
	var tt =document.getElementById("spgiamgia");
	...
	<%-- 				<a href="${pageContext.request.contextPath}/logout?logout">Logout</a> --%>
...
<div class="container">
        <header style="height:550px">
            ...
            <form:form  action="${pageContext.request.contextPath}/logout"
							...
							<input type="submit" value="Logout" style="float: right; margin:23px">
						</form:form>
            <div style="float:right; margin-top: 0px; ">
            <ul class="snip1490"  ">	
                    <li id="gly04" onClick="LogoutF();"><a href="${user}"><div class="glyphicon glyphicon-user"></div> Tài khoản</a>     
                    </li>
            </ul>
			...
			<c:url var="searchProductHome" value="/khachhang/searchProductHome?maThuongHieu=${txtSearch}"/>
      ...
      <div class="row">
        <div class="container padding">
            <div
            style=" margin-top: 15px; padding-bottom: 10px; padding-top: 10px; overflow: hidden; display: block">
            <h3 id="spnoibat"
              style="text-align: center; display: block; width: 100%; margin-top: 0; float: left; margin-bottom: 0; font-weight: 600; font-family: inherit; line-height: 1.2;">
              SẢN PHẨM NỔI BẬT</h3>
          </div>
        </div>
    </div>
    <div class="row">
        <div class="container padding">
            <div style=" margin-top: 15px; padding-bottom: 10px; padding-top: 10px; overflow: hidden; display: block; border-bottom: 1px solid #f3f3f3; border: 1px solid #f3f3f3; border-right: 1px solid #f3f3f3 !important;">
                <h6 id="spbanchay" style="color: black; display: block; width: 100%; margin-top: 0; float: left; margin-bottom: 0;font-size: 15px; font-weight: 600; font-family: inherit; line-height: 1.2;">SẢN PHẨM BÁN CHẠY</h6>
            </div>
                ...
                <c:forEach items="${spBanChay}" var="spBanChay">
							...
							<div class="col-lg-2 mb-4 text-center">
									<div class="product-entry border">
										<a href="${ctsp }"
											class="prod-img"> <img
											src="${pageContext.request.contextPath}/resources/img/gucci/gucci_bloom_edp_50ml.png" class="img-fluid"
    ...
    <div class="row">
        <div class="container padding">
            <div style=" margin-top: 15px; padding-bottom: 10px; padding-top: 10px; overflow: hidden; display: block; border-bottom: 1px solid #f3f3f3; border: 1px solid #f3f3f3; border-right: 1px solid #f3f3f3 !important;">
                <h6 id="spgiamgia" style="color: black; display: block; width: 100%; margin-top: 0; float: left; margin-bottom: 0;font-size: 15px; font-weight: 600; font-family: inherit; line-height: 1.2;">SẢN PHẨM GIẢM GIÁ</h6>
            </div>
            <div class="row padding">
						<c:forEach items="${spGiamGia}" var="spGiamGia">
							<c:url var="ctsp" value="/khachhang/id">
								<c:param name="gucciId" value="${spGiamGia.maSanPham }" />
							</c:url>
							<div class="col-lg-2 mb-4 text-center">
								<a href="${ctsp }" class="prod-img"> <img
									src="${pageContext.request.contextPath}/resources/img/gucci/gucci_bloom_edp_50ml.png"
									class="img-fluid" alt="Free html5 bootstrap 4 template">
								</a>
								<div class="desc">
									<h2>
										<a href="${ctsp }"><c:out value="${spGiamGia.tenSanPham }"></c:out>
										</a>
									</h2>
									<span class="price"><c:out
														value="${spGiamGia.giathanh}"></c:out></span>
								</div>
							</div>
