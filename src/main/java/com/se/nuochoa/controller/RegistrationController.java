...
public class RegistrationController {
	...
	@Autowired
	private KhachHangService khsevices;
	...
	public String showMyLoginPage(Model theModel) {
		...
		theModel.addAttribute("Khachhang",new KhachHang());
	...
	public String processRegistrationForm(@Valid @ModelAttribute("crmUser") CrmUser theCrmUser,
		...
		KhachHang khachHang = new KhachHang(theCrmUser.getUserName(),"KHmoi","0385553842","KHmoi@gmail.com","diachi");
		khsevices.ThemKhachHang(khachHang);
